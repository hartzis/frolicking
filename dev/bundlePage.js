...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function (req) {
	  ...
	  Router.run(Routes, req.url, function (Handler, state) {
	    ...
	    html = React.renderToString(React.createElement(Handler, { params: params }));
	  });
	  return html;
	};

	/* REACT HOT LOADER */ })(); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("/Users/hartzis/projects/frolicking/node_modules/react-hot-loader/makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "page.jsx" + ": " + err.message); } }); } } })(); }
